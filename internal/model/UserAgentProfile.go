...
// UserAgentProfile 长期偏好（MySQL 事实源）
type UserAgentProfile struct {
	UserID      int64     `gorm:"primaryKey;column:user_id" json:"user_id"`
	ProfileJSON string    `gorm:"column:profile_json;type:json;not null" json:"profile_json"`
...
type UserAgentProfileEvent struct {
	...
	PatchJSON  string    `gorm:"column:patch_json;type:json;not null" json:"patch_json"`
